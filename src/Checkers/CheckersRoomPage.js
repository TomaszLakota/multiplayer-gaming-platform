...
class CheckersRoomPage extends Component {
  ...
  connect = () => {
    this.ws = new WebSocket("ws://localhost:8080/game/" + this.state.userId);
    console.log("new ws");
    console.log(this.ws);
  ...
  handleMove = (a, b, c, d) => {
    ...
    this.send(a1 + (8 - b) + "-" + a2 + (8 - d)); //TODO odkomentowac
  };
    ...
    return (
      <React.Fragment>
        ...
        <div className="row justify-content-center">
          <div className="col-8">
            <GameBoard handleMove={this.handleMove} myColor={this.state.gameState.myColor} board={this.state.board} />
          </div>
          <div className="col-4">
            <GameUI
